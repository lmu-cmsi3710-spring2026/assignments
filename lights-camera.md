...
## Background Reading
As one might expect, the [Shirley/Marscher](https://brightspace.lmu.edu/d2l/le/content/295613/viewContent/3870087/View) text continues to be our go-to source for theoretical and mathematical material. Specific to this assignment, you might find these useful:
...
[Real-Time 3D Graphics with WebGL 2](https://brightspace.lmu.edu/d2l/le/content/295613/viewContent/3870088/View) has multiple points of interest as well:
...
As before, [GLSL Essentials](https://brightspace.lmu.edu/d2l/le/content/295613/viewContent/3870089/View) emphasizes GLSL rather than mathematics: _Section 3: Vertex Shaders_ > _Drawing a simple geometry sample_ > “Simple Lighting” walks through lighting and provides shader code as well.
...
If you wish to go above and beyond, the [red](https://brightspace.lmu.edu/d2l/le/content/295613/viewContent/3870090/View), [orange](https://brightspace.lmu.edu/d2l/le/content/295613/viewContent/3870091/View), and [WebGL reference](https://brightspace.lmu.edu/d2l/le/content/295613/viewContent/3870367/View) books go into even greater depth. In particular, Chapter 12 of the orange book describes multiple lighting approaches, culminating in the “ÜberLight” model (with complete shader code!) once used in Pixar’s RenderMan software.
...
Groups that implement texture mapping in their respective libraries will get extra credit. This is spelled out step by step in the sections from _Textures_ onward in [Real-Time 3D Graphics with WebGL 2](https://brightspace.lmu.edu/d2l/le/content/295613/viewContent/3870088/View). Virtually all of the code is there; this is extra credit primarily because it’s uncertain whether there will be time to cover this fully in class, so doing this successfully will involve some self-study. General outline:
...
```bash
$ git tag assignment-0427
$ git push --tags
```

## Specific Point Allocations
This assignment is scored according to outcomes _1b_, _1c_, _2a_, _2c_, _3a_, _3c_, _3d_, and _4a_–_4f_ in the [syllabus](http://dondi.lmu.build/spring2026/cmsi3710/cmsi3710-spring2026-syllabus.pdf). For this particular assignment, graded categories are as follows:
